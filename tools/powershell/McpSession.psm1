...
function Initialize-McpSession {
    ...
    .DESCRIPTION
        ...
        module-scoped state. The function performs a best-effort /health request and emits a
        warning if that request fails, but it still initializes local module state.
