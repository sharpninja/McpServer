...
$out = Join-Path $outDir '03-pester.json'
$nunit = Join-Path $outDir '03-pester.xml'
$log = Join-Path $outDir '03-pester.log'
...
$skipped = @($result.Skipped | ForEach-Object { [ordered]@{ Name = $_.ExpandedName; Result = [string]$_.Result } })
