...
$summary = "WROTE $out Passed=$($result.PassedCount) Failed=$($result.FailedCount) Skipped=$($result.SkippedCount) Total=$($result.TotalCount) NotRun=$($result.NotRunCount) Elapsed=$($obj.ElapsedSec)"
