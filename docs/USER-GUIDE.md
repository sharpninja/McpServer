...
- resolves MCP connection details from `AGENTS-README-FIRST.yaml`, environment variables, or the sample `appsettings.yaml`
...
- Always use `scripts\Update-McpService.ps1` for updates and backup restores
