...
| v0.1.19 | 2026-09-26 | Astra re-review (round 10). Companion bump only. P2-11 is the addendum correction of what `Validate-RequirementsTraceability.ps1` fails. This whitepaper's design text is unchanged. P2-07 and P2-10 stay closed. The finding map is ADD §12 round 10, claimed remediation pending an independent Astra review, not an AGREE |
