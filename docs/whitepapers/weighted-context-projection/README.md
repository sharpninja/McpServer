...
| File | Description |
| --- | --- |
| [whitepaper-weighted-context-projection-v0.1.md](./whitepaper-weighted-context-projection-v0.1.md) | **Design only** (**v0.1.18** content; filename retained). Problem, architecture, scoring model, projection algorithm (ordered transition, generation snapshot with `sendFence`, pin/harm precedence, replacement-checked warning retirement, joint admission including depth truncation, token stability including the mixed-pressure split floored once per packing step), related work with MemGPT scored on the durable-store and hard-ceiling axes, evaluation method, glossary, references |
| [proposed-implementation-weighted-context-projection-v0.1.md](./proposed-implementation-weighted-context-projection-v0.1.md) | **Proposed implementation** (v0.1.13). Deployment options, code-grounded corrections against `main` @ `e7c43a12`, sealed-projection design, recommendations, roadmap and phase gates, next actions, open questions. Replaces `implementation-recommendations-v0.1.md`. Phase gates follow WP v0.1.18 on the send fence, active markers, and the two stability metrics |
| [addendum-retrospective-linking-and-goal-metrics-v0.1.md](./addendum-retrospective-linking-and-goal-metrics-v0.1.md) | **Draft addendum** (v0.1.15). Incorporates PR #56, the PR #58 pin exception, and Astra re-reviews through round 9 (finding maps in §12). Round 9 text for P2-07 is claimed remediation, pending an independent Astra review. P2-10 stays closed. Not operator-approved. Proposes work beyond v0.1.x: retrospective link index over sealed turns, continuous link revalidation, per-goal scope/progress metrics, and turn outcome records adjudicated by Hostile Validation. Read after the other two |
...
- Two self-eval rounds completed (receipts above, against v0.1.2). Paper version now **v0.1.18** after the hostile full-document review and the Astra re-reviews through round 9; the self-evals predate those fixes. Round 9 text for P2-07 is claimed remediation, pending an independent Astra review. P2-10 stays closed.
...
Draft. Whitepaper **v0.1.18**, proposed implementation **v0.1.13**, addendum **v0.1.15**. Whitepaper, implementation, and addendum revised 2026-09-26 for the hostile-review contract and the Astra re-review through round 9; America/Chicago. Round 9 text for P2-07 is claimed remediation, pending an independent Astra review. P2-10 stays closed. Awaiting operator Payton Byrd review. Author: Payton Byrd.
