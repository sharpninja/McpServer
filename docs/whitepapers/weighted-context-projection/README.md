...
| File | Description |
| --- | --- |
| [whitepaper-weighted-context-projection-v0.1.md](./whitepaper-weighted-context-projection-v0.1.md) | Full technical whitepaper (**v0.1.2** content; filename retained) |
...
Draft **v0.1.2** — 2026-09-20 (America/Chicago). Awaiting operator Payton Byrd review. Author: Payton Byrd.
