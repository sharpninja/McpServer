...
- Two self-eval rounds completed (receipts above, against v0.1.2). Paper version now **v0.1.17** after the hostile full-document review and the Astra re-reviews through round 8; the self-evals predate those fixes. Round 8 text for P2-07 and P2-10 is claimed remediation, pending an independent Astra review.
...
Draft. Whitepaper **v0.1.17**, proposed implementation **v0.1.12**, addendum **v0.1.14**. Whitepaper, implementation, and addendum revised 2026-09-26 for the hostile-review contract and the Astra re-review through round 8; America/Chicago. Round 8 text for P2-07 and P2-10 is claimed remediation, pending an independent Astra review. Awaiting operator Payton Byrd review. Author: Payton Byrd.
