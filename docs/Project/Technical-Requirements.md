...
**REPL import and plugin integration** — Expose shared transcript conversion/import through REPL and plugin helpers without duplicating parser logic or handwritten YAML.
**Covered by:** FR: FR-MCP-TRANSCRIPT-005; TEST: TEST-MCP-TRANSCRIPT-006, TEST-MCP-TRANSCRIPT-010
**Status:** pending
Scope: layer-1+
**Acceptance Criteria:**
- [ ] Claude, Codex, and Grok plugin helpers locate active transcripts and delegate to shared typed surfaces.
