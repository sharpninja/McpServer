...
**Covered by:** `LegacyTodoSqliteMigrator`, `TodoDocumentMetadataEntity` (SingletonId `ValueGeneratedNever`), `LegacyTodoSqliteMigratorTests`, `TodoDocumentMetadataModelTests`
