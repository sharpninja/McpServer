...
/// <summary>
/// TR-PLANNED-CORE-013: Configuration for MCP ingestion (repo root, paths, allowlists).
/// FR-SUPPORT-010: Repo and session log paths.
/// </summary>
public sealed class IngestionOptions
{
    /// <summary>TR-PLANNED-CORE-013: Repository root (e.g. workspace path).</summary>
    public string RepoRoot { get; set; } = ".";

    /// <summary>TR-PLANNED-CORE-013: Path to TODO data file when using YAML storage.</summary>
    ...
    /// <summary>TR-PLANNED-CORE-013: Path to UnifiedModel schema (for reference).</summary>
    ...
    /// <summary>TR-PLANNED-CORE-013: Allowed repo path patterns (e.g. "*.md", "*.cs", "docs/**"). Null = all under RepoRoot.</summary>
    public IReadOnlyList<string>? RepoAllowlist { get; set; }

    /// <summary>TR-PLANNED-CORE-013: Maximum file size in bytes to ingest (default 1 MB).</summary>
