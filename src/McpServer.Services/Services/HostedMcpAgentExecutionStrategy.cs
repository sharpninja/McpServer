...
{
    public string Name => AgentExecutionStrategyNames.HostedMcpAgent;
    ...
    private static McpAgentOptions CreateHostedAgentOptions(
        AgentExecutionSessionRequest request,
    ...
    private sealed class HostedAgentExecutionSession : IAgentExecutionSession
    {
            ...
            [EnumeratorCancellation] CancellationToken cancellationToken)
        {
            ...
            {
                _logger.LogWarning(ex, "Hosted MCP Agent streaming execution failed for workspace {WorkspacePath}", _request.WorkspacePath);
