...
public sealed class SessionLogSanitizer : ISessionLogSanitizer
{
    ...
    public UnifiedSessionLogDto? SanitizeSessionLog(UnifiedSessionLogDto? sessionLog)
    {
        ...
        return new UnifiedSessionLogDto
        {
            ...
            AgentSessionId = SanitizeString(sessionLog.AgentSessionId),
            AgentSessionTranscriptFile = SanitizeString(sessionLog.AgentSessionTranscriptFile),
            AgentExecutablePath = SanitizeString(sessionLog.AgentExecutablePath),
            AgentExecutableVersion = SanitizeString(sessionLog.AgentExecutableVersion),
