...
public sealed class ContextDocumentEntity
{
    ...
    /// <summary>Navigation to chunks. EF Core populates the initialized collection during relationship fixup.</summary>
    public ICollection<ContextChunkEntity> Chunks { get; } = new List<ContextChunkEntity>();
}
