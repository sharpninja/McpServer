...
/// <summary>
/// TR-PLANNED-CORE-013: 4NF context item entity. One row per context reference on a session log entry.
/// FR-SUPPORT-010: Eliminates multi-valued dependency on context list.
/// </summary>
public sealed class SessionLogTurnContextEntity
{
    ...
    /// <summary>TR-PLANNED-CORE-013: Ordinal position within the context list.</summary>
