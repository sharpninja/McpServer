        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Metadata = table.Column<string>(type: "TEXT", maxLength: 8192, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    WorkspaceId = table.Column<string>(type: "TEXT", nullable: false),
                    SourceEntityId = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    TargetEntityId = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    RelationshipType = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    Description = table.Column<string>(type: "TEXT", maxLength: 4096, nullable: true),
