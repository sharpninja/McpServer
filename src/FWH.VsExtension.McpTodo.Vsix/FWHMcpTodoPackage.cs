...
[ProvideToolWindow(typeof(FWHMcpTodoToolWindowPane), Style = VsDockStyle.Tabbed, Window = "3ae79031-e1bc-11d0-8f78-00a0c9110057")]
[ProvideAutoLoad(UIContextGuids80.SolutionExists, PackageAutoLoadFlags.BackgroundLoad)]
public sealed class FWHMcpTodoPackage : AsyncPackage, IVsSolutionEvents
{
    ...
    protected override async Task InitializeAsync(CancellationToken cancellationToken, IProgress<ServiceProgressData> progress)
    {
        ...
        try
        {
            ...
            await FWHMcpTodoToolWindowCommand.InitializeAsync(this);
            ActivityLog.LogInformation("FWHMcpTodoPackage", "Package initialized successfully. Command registered.");
        }
        catch (Exception ex)
        {
            ActivityLog.LogError("FWHMcpTodoPackage", $"InitializeAsync failed: {ex}");
            throw;
        }
    }
    ...
    private async Task TryEnableTodoAsync(CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            if (dte?.Solution?.FullName is string slnPath && !string.IsNullOrEmpty(slnPath))
            {
                ...
                {
                    ActivityLog.LogInformation("FWHMcpTodoPackage", $"Solution '{slnName}' is not FunWasHad — todo disabled.");
                    return;
                }
        ...
        ActivityLog.LogInformation("FWHMcpTodoPackage", "FunWasHad solution detected — todo enabled.");
    ...
    private void DisableTodo()
    {
        ...
        ActivityLog.LogInformation("FWHMcpTodoPackage", "Solution closed — todo disabled.");
    }
