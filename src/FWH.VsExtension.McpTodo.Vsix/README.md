# FWH MCP Todo – Visual Studio extension (VSIX)
...
3. Build the project **FWH.VsExtension.McpTodo.Vsix** (or build the solution).
4. The VSIX is produced at `bin\Debug\FWH.VsExtension.McpTodo.vsix` or `bin\Release\...`.
