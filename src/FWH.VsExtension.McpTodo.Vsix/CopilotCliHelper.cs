...
/// Mirrors the approach in FWH.Common.Copilot but without external dependencies.
/// </summary>
...
/// <summary>
/// Writes to the "FWH Copilot" output window pane in Visual Studio.
...
{
    private const string PaneTitle = "FWH Copilot";
