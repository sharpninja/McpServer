...
internal static class FWHMcpTodoToolWindowCommand
{
    ...
    private const string LogSource = "FWHMcpTodoCommand";
    ...
    private static void Execute(object sender, EventArgs e)
    {
        ...
        _ = s_package.JoinableTaskFactory.RunAsync(async () =>
        {
            try
            {
                ...
                var window = await s_package!.ShowToolWindowAsync(typeof(FWHMcpTodoToolWindowPane), 0, true, s_package.DisposalToken).ConfigureAwait(true);
