...
namespace McpServer.Support.Mcp.Storage.SqliteMigrations.Migrations
{
    ...
    public partial class AddMemoryVersionAndEdgeStorage : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.AddColumn<string>(name: "CreatedBy", table: "Memories", type: "TEXT", maxLength: 256, nullable: true);
            migrationBuilder.AddColumn<string>(name: "EmbeddingStatus", table: "Memories", type: "TEXT", maxLength: 32, nullable: true);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    VersionRowId = table.Column<long>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    MemoryId = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    EdgeRowId = table.Column<long>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    FromMemoryId = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    ToMemoryId = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Memories_WorkspaceId_Scope",
                table: "Memories",
                columns: new[] { "WorkspaceId", "Scope" });
            migrationBuilder.CreateIndex(
                name: "IX_Memories_EmbeddingStatus",
                table: "Memories",
                column: "EmbeddingStatus");
            migrationBuilder.CreateIndex(
                name: "IX_MemoryVersions_MemoryId_VersionNumber",
                table: "MemoryVersions",
                columns: new[] { "MemoryId", "VersionNumber" },
                unique: true);
            migrationBuilder.CreateIndex(
                name: "IX_MemoryEdges_FromMemoryId_ToMemoryId_EdgeType",
                table: "MemoryEdges",
                columns: new[] { "FromMemoryId", "ToMemoryId", "EdgeType" },
                unique: true);
        }
