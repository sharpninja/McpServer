        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SlotId = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    ...
                    ProviderKind = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    ...
                    PartyId = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    InvocationId = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    WorkspaceId = table.Column<string>(type: "TEXT", maxLength: 1024, nullable: false),
                    SlotId = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    Role = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    ProviderKind = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    ...
                    TransactionId = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                    DiffgramId = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                    PromptSha256 = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                    OutputSha256 = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                    AdmitToGraphRag = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                ...
                unique: true,
                filter: "\"Enabled\" = 1 AND \"IsDeleted\" = 0");
