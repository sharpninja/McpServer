        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GroupKey = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    EffectiveWorkspacePath = table.Column<string>(type: "TEXT", maxLength: 1024, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkspaceId = table.Column<string>(type: "TEXT", maxLength: 1024, nullable: false),
                    GroupId = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    OriginalWorkspacePath = table.Column<string>(type: "TEXT", maxLength: 1024, nullable: false),
                    EffectiveWorkspacePath = table.Column<string>(type: "TEXT", maxLength: 1024, nullable: false),
                    Title = table.Column<string>(type: "TEXT", maxLength: 512, nullable: false),
                    Summary = table.Column<string>(type: "TEXT", nullable: false),
                    ...
                    ReporterAgent = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                    ...
                    CurrentTodoId = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GroupId = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    Status = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    PromptTemplateId = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
