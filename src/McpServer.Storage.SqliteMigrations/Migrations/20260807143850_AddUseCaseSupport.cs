    ...
    public partial class AddUseCaseSupport : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UseCaseId = table.Column<long>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    WorkspaceId = table.Column<string>(type: "TEXT", maxLength: 1024, nullable: false),
                    ...
                    ApprovalStatus = table.Column<string>(type: "TEXT", maxLength: 32, nullable: false, defaultValue: "Draft"),
                    ProductKey = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                    DeleteReason = table.Column<string>(type: "TEXT", maxLength: 1024, nullable: true),
                    DeletedAtUtc = table.Column<DateTime>(type: "TEXT", nullable: true),
                    DeletedBy = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                    IsDeleted = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ExtensionPointId = table.Column<long>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    WorkspaceId = table.Column<string>(type: "TEXT", maxLength: 1024, nullable: false),
                    UseCaseId = table.Column<long>(type: "INTEGER", nullable: false),
                    Name = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkspaceId = table.Column<string>(type: "TEXT", maxLength: 1024, nullable: false),
                    UseCaseId = table.Column<long>(type: "INTEGER", nullable: false),
                    FlowType = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FrKind = table.Column<string>(type: "TEXT", maxLength: 16, nullable: false, defaultValue: "fr"),
                    LinkType = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false, defaultValue: "Realizes"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SpecialReqId = table.Column<long>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    WorkspaceId = table.Column<string>(type: "TEXT", maxLength: 1024, nullable: false),
                    UseCaseId = table.Column<long>(type: "INTEGER", nullable: false),
