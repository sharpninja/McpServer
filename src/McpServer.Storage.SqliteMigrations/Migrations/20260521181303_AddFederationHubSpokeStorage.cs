    ...
    public partial class AddFederationHubSpokeStorage : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProxyId = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OperationId = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    ProxyId = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    SourceOperationId = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                    GlobalWorkspaceId = table.Column<string>(type: "TEXT", maxLength: 512, nullable: true),
                    Domain = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    ResourceId = table.Column<string>(type: "TEXT", maxLength: 1024, nullable: true),
                    HttpMethod = table.Column<string>(type: "TEXT", maxLength: 32, nullable: true),
                    Path = table.Column<string>(type: "TEXT", maxLength: 2048, nullable: true),
                    Method = table.Column<string>(type: "TEXT", maxLength: 512, nullable: true),
                    HeadersJson = table.Column<string>(type: "TEXT", nullable: true),
                    BodyBase64 = table.Column<string>(type: "TEXT", nullable: true),
                    BaseVersion = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                    HubVersion = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                    Status = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GlobalWorkspaceId = table.Column<string>(type: "TEXT", maxLength: 512, nullable: false),
                    ProxyId = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    WorkspaceName = table.Column<string>(type: "TEXT", maxLength: 512, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ConflictId = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    OperationId = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    ProxyId = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    Domain = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    ResourceId = table.Column<string>(type: "TEXT", maxLength: 1024, nullable: true),
                    ProxyVersion = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                    HubVersion = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                    ResolutionStatus = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
