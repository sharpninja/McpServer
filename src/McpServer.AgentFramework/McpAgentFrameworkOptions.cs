...
/// <summary>
/// FR-MCP-066/TR-MCP-AGENT-006: Configuration for the scaffolded MCP Server Agent Framework host integration.
/// </summary>
public sealed class McpAgentFrameworkOptions
{
    /// <summary>
    /// Configuration section name reserved for the Agent Framework integration.
    /// </summary>
    public const string SectionName = "McpServer:AgentFramework";
