...
builder.Services.Configure<KeyServerOptions>(builder.Configuration.GetSection(KeyServerOptions.SectionName));
builder.Services.Configure<SubscriberOptions>(builder.Configuration.GetSection(SubscriberOptions.SectionName));
builder.Services.Configure<TurnTransactionOptions>(builder.Configuration.GetSection(TurnTransactionOptions.SectionName));
...
builder.Services.AddSingleton<ITransactionManifestCanonicalizer, TransactionManifestCanonicalizer>();
builder.Services.AddSingleton<InMemoryKeyServerService>();
builder.Services.AddSingleton<IKeyServerPartyRegistry>(sp => sp.GetRequiredService<InMemoryKeyServerService>());
builder.Services.AddSingleton<IKeyServerManifestService>(sp => sp.GetRequiredService<InMemoryKeyServerService>());
builder.Services.AddSingleton<ISubscriberCommitService, InMemorySubscriberCommitService>();
builder.Services.AddSingleton<ITransactionDegradedModePolicy, TransactionDegradedModePolicy>();
builder.Services.AddSingleton<ITransactionAuditWriter, InMemoryTransactionAuditWriter>();
builder.Services.AddSingleton<IDiffgramBuilder, JsonDiffgramBuilder>();
builder.Services.AddSingleton<ITurnTransactionCoordinator, TurnTransactionCoordinator>();
