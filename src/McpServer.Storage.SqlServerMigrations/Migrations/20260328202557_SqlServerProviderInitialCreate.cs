...
{
    /// <inheritdoc />
    public partial class SqlServerProviderInitialCreate : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultLaunchCommand = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: false),
                    DefaultInstructionFile = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    DefaultModelsJson = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DefaultBranchStrategy = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    DefaultSeedPrompt = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkspacePath = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SourceKey = table.Column<string>(type: "nvarchar(2048)", maxLength: 2048, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Repo = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    Branch = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    ManifestPath = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: false),
                    DateTimeCreated = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    DateTimeLastSynced = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParameterSchema = table.Column<string>(type: "nvarchar(max)", maxLength: 8192, nullable: true),
                    CommandTemplate = table.Column<string>(type: "nvarchar(2048)", maxLength: 2048, nullable: true),
                    WorkspacePath = table.Column<string>(type: "nvarchar(2048)", maxLength: 2048, nullable: true),
                    BucketName = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    DateTimeCreated = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    WorkspaceId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    AgentDefinitionId = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    WorkspacePath = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: false),
                    Enabled = table.Column<bool>(type: "bit", nullable: false),
                    Banned = table.Column<bool>(type: "bit", nullable: false),
                    BannedReason = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: true),
                    BannedUntilPr = table.Column<int>(type: "int", nullable: true),
                    AgentIsolation = table.Column<string>(type: "nvarchar(16)", maxLength: 16, nullable: false),
                    LaunchCommandOverride = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: true),
                    ModelsOverrideJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BranchStrategyOverride = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    SeedPromptOverride = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MarkerAdditions = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    InstructionFilesOverrideJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RestartPolicy = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CursorSessionLabel = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: true),
                    CopilotAvgSuccessScore = table.Column<double>(type: "float", nullable: true),
                    CopilotTotalNetTokens = table.Column<int>(type: "int", nullable: true),
                    CopilotTotalNetPremiumRequests = table.Column<int>(type: "int", nullable: true),
                    CopilotCompletedCount = table.Column<int>(type: "int", nullable: true),
                    CopilotInProgressCount = table.Column<int>(type: "int", nullable: true),
                    Project = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    TargetFramework = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    ...
                    SourceFilePath = table.Column<string>(type: "nvarchar(2048)", maxLength: 2048, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Model = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    ModelProvider = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    QueryText = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    QueryTitle = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: true),
                    ...
                    FailureNote = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    OriginalEntryJson = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CommitTimestamp = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    FilesChangedJson = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SessionLogTurnId = table.Column<long>(type: "bigint", nullable: false),
                    Ordinal = table.Column<int>(type: "int", nullable: false),
                    ContextItem = table.Column<string>(type: "nvarchar(2048)", maxLength: 2048, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                ...
                unique: true,
                filter: "[WorkspacePath] IS NOT NULL");
