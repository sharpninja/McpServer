        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SourceLocator = table.Column<string>(type: "nvarchar(2048)", maxLength: 2048, nullable: false),
                    ...
                    PromptVersion = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    TemplateVersion = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    Agent = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    ...
                    ReplayIdentity = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    ProcessingState = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
                    ProcessingOwner = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    ProcessingLeaseExpiresAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ApprovalOwner = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    ApprovalLeaseExpiresAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    TodoCreationIntentId = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
