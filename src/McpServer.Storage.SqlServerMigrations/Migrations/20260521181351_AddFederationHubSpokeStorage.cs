    ...
    public partial class AddFederationHubSpokeStorage : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProxyId = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OperationId = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    ProxyId = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    SourceOperationId = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    GlobalWorkspaceId = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: true),
                    Domain = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    ResourceId = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: true),
                    ...
                    BodyBase64 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BaseVersion = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    HubVersion = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    Status = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GlobalWorkspaceId = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: false),
                    ProxyId = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    WorkspaceName = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ConflictId = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    OperationId = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    ProxyId = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    Domain = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    ResourceId = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: true),
                    ProxyVersion = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    HubVersion = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    ResolutionStatus = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
