        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GroupKey = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    EffectiveWorkspacePath = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkspaceId = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: false),
                    GroupId = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    OriginalWorkspacePath = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: false),
                    EffectiveWorkspacePath = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: false),
                    Title = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: false),
                    Summary = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ObservedBehavior = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    DedupeKey = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: true),
                    ErrorSignature = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Fingerprint = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    AffectedPathsJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AffectedSymbolsJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    EvidenceJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ReproductionHintsJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TagsJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ReporterAgent = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    SessionId = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    TurnId = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    CurrentTodoId = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GroupId = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    Status = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    PromptTemplateId = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
