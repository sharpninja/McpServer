...
public sealed class TodoLifecycleSequenceTests
{
    ...
    public async Task FullLifecycle_CreateThroughDelete()
    {
        ...
        try
        {
            ...
            var createResult = await createResponse.Content.ReadFromJsonAsync<TodoMutationResult>(cancellationToken: TestContext.Current.CancellationToken);
            ...
            var list2Result = await list2.Content.ReadFromJsonAsync<TodoQueryResult>(cancellationToken: TestContext.Current.CancellationToken);
            ...
            var getResponse = await client.GetAsync($"{route}/{Uri.EscapeDataString(testId)}", cancellationToken: TestContext.Current.CancellationToken);
            Assert.Equal(HttpStatusCode.OK, getResponse.StatusCode);
            var item = await getResponse.Content.ReadFromJsonAsync<TodoFlatItem>(cancellationToken: TestContext.Current.CancellationToken);
            Assert.NotNull(item);
            ...
            var queryById = await client.GetAsync($"{route}?id={Uri.EscapeDataString(testId)}", cancellationToken: TestContext.Current.CancellationToken);
            var queryByIdResult = await queryById.Content.ReadFromJsonAsync<TodoQueryResult>(cancellationToken: TestContext.Current.CancellationToken);
            ...
            var updateResponse = await client.PutAsJsonAsync($"{route}/{Uri.EscapeDataString(testId)}", updateBody, cancellationToken: TestContext.Current.CancellationToken);
            Assert.Equal(HttpStatusCode.OK, updateResponse.StatusCode);
            var updateResult = await updateResponse.Content.ReadFromJsonAsync<TodoMutationResult>(cancellationToken: TestContext.Current.CancellationToken);
            ...
            var get2 = await client.GetAsync($"{route}/{Uri.EscapeDataString(testId)}", cancellationToken: TestContext.Current.CancellationToken);
            var item2 = await get2.Content.ReadFromJsonAsync<TodoFlatItem>(cancellationToken: TestContext.Current.CancellationToken);
            ...
            var doneResponse = await client.PutAsJsonAsync($"{route}/{Uri.EscapeDataString(testId)}", doneBody, cancellationToken: TestContext.Current.CancellationToken);
            Assert.Equal(HttpStatusCode.OK, doneResponse.StatusCode);
            var doneResult = await doneResponse.Content.ReadFromJsonAsync<TodoMutationResult>(cancellationToken: TestContext.Current.CancellationToken);
            ...
            var doneQuery = await client.GetAsync($"{route}?done=true", cancellationToken: TestContext.Current.CancellationToken);
            var doneQueryResult = await doneQuery.Content.ReadFromJsonAsync<TodoQueryResult>(cancellationToken: TestContext.Current.CancellationToken);
            ...
            using (var timeoutCts = new CancellationTokenSource(TimeSpan.FromSeconds(30)))
            {
                try
                {
                    ...
                    var reqResult = await reqResponse.Content.ReadFromJsonAsync<RequirementsAnalysisResult>(cancellationToken: TestContext.Current.CancellationToken);
            ...
            var deleteResponse = await client.DeleteAsync($"{route}/{Uri.EscapeDataString(testId)}", cancellationToken: TestContext.Current.CancellationToken);
            Assert.Equal(HttpStatusCode.OK, deleteResponse.StatusCode);
            var deleteResult = await deleteResponse.Content.ReadFromJsonAsync<TodoMutationResult>(cancellationToken: TestContext.Current.CancellationToken);
            ...
            var getGone = await client.GetAsync($"{route}/{Uri.EscapeDataString(testId)}", cancellationToken: TestContext.Current.CancellationToken);
            ...
            var listFinalResult = await listFinal.Content.ReadFromJsonAsync<TodoQueryResult>(cancellationToken: TestContext.Current.CancellationToken);
        ...
        catch
        {
            ...
            try { await client.DeleteAsync($"{route}/{Uri.EscapeDataString(testId)}", cancellationToken: TestContext.Current.CancellationToken); }
            catch { /* swallow */ }
            throw;
        }
    }
