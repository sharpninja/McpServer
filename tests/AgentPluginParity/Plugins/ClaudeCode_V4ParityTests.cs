// Phase 3 parity adoption tests for mcpserver-claude-code-plugin (TR-MCP-AGENT-PARITY-020).
...
// Plugin root resolved from sibling directory or CLAUDE_PLUGIN_ROOT env var.
using System;
using System.IO;
using Xunit;
...
/// <summary>TR-MCP-AGENT-PARITY-020: Phase 3 parity assertions for mcpserver-claude-code-plugin.</summary>
public class ClaudeCode_V4ParityTests
{
    ...
    [Fact]
    public void ClaudeCode_CacheManager_MaxRetriesIsThree()
    {
    ...
    [Fact]
    public void ClaudeCode_HooksJson_HasFullRequiredSurface()
    {
    ...
    [Fact]
    public void ClaudeCode_Skills_HasAll5CoreSurfaces()
    {
    ...
    [Fact]
    public void ClaudeCode_MarkerResolver_UsesHmacSha256()
    {
    ...
    [Fact]
    public void ClaudeCode_SubagentCapture_ScriptsPresent()
    {
    ...
    // =========================================================================
    // Phase 3 gaps - RED until plugin fixes applied
    // =========================================================================

    /// <summary>ENFORCEMENT.md must document the shared v4 protocol (TR-MCP-AGENT-PARITY-020).</summary>
    [Fact]
    public void ClaudeCode_HasEnforcementMd_ReferencingSharedProtocol()
    {
        ...
        Assert.True(found != null,
            "ENFORCEMENT.md missing from plugin root, lib/, or docs/ (required for Phase 3 parity)");
    ...
    [Fact]
    public void ClaudeCode_CacheScope_ProvidesBase64UrlWorkspaceKey()
    {
        var content = ReadLib("cache-scope.sh");
        // Phase 3: v4 parity adds cache_scope_workspace_key_v4 using base64url encoding
    ...
    [Fact]
    public void ClaudeCode_CacheScope_ProvidesV1FailsafeLayout()
    {
        var content = ReadLib("cache-scope.sh");
        // Phase 3: v4 parity adds cache_scope_v4_failsafe_root using .mcpServer/failsafe/ layout
    ...
    [Fact]
    public void ClaudeCode_Version_IsOnV1Line()
    {
