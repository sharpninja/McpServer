...
public sealed class McpSessionIdentifierFactoryTests
{
    ...
    /// </summary>
    [Fact]
    public void AddMcpServerAgentFramework_RegistersIdentifierFactory()
    {
        ...
        var hostedAgent = serviceProvider.GetRequiredService<AgentFramework.IMcpHostedAgent>();
    ...
    {
        var options = Options.Create(new McpAgentFrameworkOptions
        {
            ApiKey = "token",
