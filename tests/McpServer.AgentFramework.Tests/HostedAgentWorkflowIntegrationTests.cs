...
/// <see cref="ServiceCollectionExtensions.AddMcpServerAgentFramework(Microsoft.Extensions.DependencyInjection.IServiceCollection, Action{McpAgentFrameworkOptions})"/>,
...
public sealed class HostedAgentWorkflowIntegrationTests
{
    ...
    /// </summary>
    [Fact]
    public async Task AddMcpServerAgentFramework_FactoryCreatedHostedAgent_ExecutesBuiltInWorkflowTools()
    {
        ...
        var beginTurnResult = await tools["mcp_session_turn_begin"].InvokeAsync(
            new AIFunctionArguments
            {
                ["request"] = new SessionLogTurnCreateRequest
                {
                    ...
                    ContextList = [@"tests\McpServer.AgentFramework.Tests\HostedAgentWorkflowIntegrationTests.cs"],
                },
            },
            CancellationToken.None);
        ...
        var completeTurnResult = await tools["mcp_session_turn_complete"].InvokeAsync(
            new AIFunctionArguments
            {
                ["request"] = new SessionLogTurnCompleteRequest
                {
                    ...
                    FilesModified = [@"tests\McpServer.AgentFramework.Tests\HostedAgentWorkflowIntegrationTests.cs"],
        ...
        Assert.Equal([@"tests\McpServer.AgentFramework.Tests\HostedAgentWorkflowIntegrationTests.cs"], completedTurn.ContextList);
    ...
    /// </summary>
    [Fact]
    public async Task AddMcpServerAgentFramework_HostedAgentFactory_CreatesIsolatedWorkflowContexts()
    {
        using var serviceProvider = CreateServiceProvider(out var handler);
