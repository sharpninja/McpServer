...
public sealed class ServiceCollectionExtensionsTests
{
    ...
    /// </summary>
    [Fact]
    public void AddMcpServerAgentFramework_RegistersScaffoldedHostedAgent()
    {
        ...
        Assert.IsType<McpServer.AgentFramework.SessionLog.SessionLogWorkflow>(hostedAgent.SessionLog);
    ...
    /// </summary>
    [Fact]
    public void AddMcpServerAgentFramework_RegistersOptionsValidator()
    {
        var services = new ServiceCollection();
        services.AddMcpServerAgentFramework(options =>
        {
        ...
        using var serviceProvider = services.BuildServiceProvider();
        var validators = serviceProvider.GetServices<IValidateOptions<McpAgentFrameworkOptions>>();

        Assert.Contains(validators, static validator => validator is McpAgentFrameworkOptionsValidator);
    }
    ...
    /// </summary>
    [Fact]
    public void AddMcpServerAgentFramework_RegistersHostedAgentFactory()
    {
        var services = new ServiceCollection();
        services.AddMcpServerAgentFramework(options =>
        {
    ...
    /// </summary>
    [Fact]
    public void AddMcpServerAgentFramework_ThrowsWhenAuthenticationIsMissing()
    {
        var services = new ServiceCollection();
        services.AddMcpServerAgentFramework(options =>
        {
    ...
    /// </summary>
    [Fact]
    public void AddMcpServerAgentFramework_AllowsBearerTokenAuthentication()
    {
        var services = new ServiceCollection();
        services.AddMcpServerAgentFramework(options =>
        {
    ...
    /// </summary>
    [Fact]
    public void AddMcpServerAgentFramework_ThrowsWhenSourceTypeIsInvalid()
    {
        var services = new ServiceCollection();
        services.AddMcpServerAgentFramework(options =>
        {
    ...
    /// </summary>
    [Fact]
    public void AddMcpServerAgentFramework_ThrowsWhenWorkspacePathIsNotFullyQualified()
    {
        var services = new ServiceCollection();
        services.AddMcpServerAgentFramework(options =>
        {
    ...
    /// </summary>
    [Fact]
    public void AddMcpServerAgentFramework_ThrowsWhenBaseUrlSchemeIsInvalid()
    {
        var services = new ServiceCollection();
        services.AddMcpServerAgentFramework(options =>
        {
    ...
    /// </summary>
    [Fact]
    public void AddMcpServerAgentFramework_AllowsMissingAuthenticationWhenDisabled()
    {
        var services = new ServiceCollection();
        services.AddMcpServerAgentFramework(options =>
        {
    ...
    /// <summary>
    /// TEST-MCP-089: Verifies that hosts can preconfigure <see cref="McpAgentFrameworkOptions"/> through the standard options pipeline and then register the Agent Framework services.
    ...
    /// </summary>
    [Fact]
    public void AddMcpServerAgentFramework_UsesPreconfiguredOptions()
    {
        var services = new ServiceCollection();
        ...
        services.AddMcpServerAgentFramework();
