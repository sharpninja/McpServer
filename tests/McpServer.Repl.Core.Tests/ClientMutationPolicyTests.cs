...
public sealed class ClientMutationPolicyTests
{
    ...
    [InlineData("graphRag", "StatusAsync", true)]
    [InlineData("graphRag", "QueryAsync", true)]
    [InlineData("graphRag", "ListDocumentsAsync", true)]
    [InlineData("graphRag", "GetDocumentChunksAsync", true)]
    [InlineData("graphRag", "ListEntitiesAsync", true)]
    [InlineData("graphRag", "GetEntityAsync", true)]
    [InlineData("graphRag", "ListRelationshipsAsync", true)]
    [InlineData("graphRag", "GetRelationshipAsync", true)]
    [InlineData("graphRag", "IndexAsync", false)]
    [InlineData("graphRag", "IngestTextAsync", false)]
    [InlineData("graphRag", "DeleteDocumentAsync", false)]
    [InlineData("graphRag", "CreateEntityAsync", false)]
    [InlineData("graphRag", "UpdateEntityAsync", false)]
    [InlineData("graphRag", "DeleteEntityAsync", false)]
    [InlineData("graphRag", "CreateRelationshipAsync", false)]
    [InlineData("graphRag", "UpdateRelationshipAsync", false)]
    [InlineData("graphRag", "DeleteRelationshipAsync", false)]
