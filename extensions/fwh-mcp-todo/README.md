...
- **Copy ID:** Double-click a todo row (or use the context menu **FWH MCP Todo: Copy ID to clipboard**) to copy that item’s ID to the clipboard.
...
You can still use **F5 → FWH MCP Todo (Extension)** to debug; if that window keeps closing, use “Install from Location” above.
