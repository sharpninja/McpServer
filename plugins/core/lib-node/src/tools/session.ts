  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        planFile: { type: 'string', description: 'Plan file path or sentinel None' },
        todoId: { type: 'string', description: 'Canonical TODO id or sentinel None' },
      },
...
/** Re-export needed by cline v1 glue (plugin-helpers.ts). */
export function getSessionShimState() {
