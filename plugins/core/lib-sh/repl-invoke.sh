...
_repl_sessionlog_submit_http_fallback() {
    ...
    SESSION_AGENT_SESSION_ID="${MCP_AGENT_SESSION_ID:-}" \
    SESSION_AGENT_SESSION_TRANSCRIPT_FILE="${MCP_AGENT_SESSION_TRANSCRIPT_FILE:-}" \
    SESSION_AGENT_EXECUTABLE_PATH="${MCP_AGENT_EXECUTABLE_PATH:-}" \
    SESSION_AGENT_EXECUTABLE_VERSION="${MCP_AGENT_EXECUTABLE_VERSION:-}" \
